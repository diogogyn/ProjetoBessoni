...
<head>
<title>Painel de controle - Empresa - Estofados bessoni</title>
...
<div id="content">
	<div id="conteudo">
	<center>
    <h2>Digite o Conteudo da pagina Empresa no editor de texto abaixo:</h2><br />

     <div id="painel">
<?php
if (isset($_POST['cadastro']) && $_POST['cadastro'] == 'add') {
	
	$cadastra = mysql_query("INSERT INTO empresa (titulo, data, texto) VALUES ('$_POST[titulo]', '$_POST[data]', '$_POST[texto]')");
...
if (isset($_POST['apagar']) && $_POST['apagar'] == 'excluir') {
	...
	$deleta = mysql_query("DELETE FROM empresa WHERE id = '$_POST[id]'");
...
<?php
$sql = "SELECT id, titulo FROM empresa ORDER BY data DESC, id DESC";
